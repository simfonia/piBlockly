...
Blockly.Blocks['arduino_constrain'] = {
  init: function() {
    this.jsonInit({
      "message0": "%{BKY_ARDUINO_CONSTRAIN_TITLE}",
      "args0": [
        {
          "type": "input_value",
          "name": "VALUE",
      ...
      "inputsInline": true,
      "output": "Number",
      "colour": Blockly.Msg.ARDUINO_MATH_HUE,
...
Blockly.Blocks['arduino_map'] = {
  init: function() {
    this.jsonInit({
      "message0": "%{BKY_ARDUINO_MAP_TITLE}",
      "args0": [
        {
          "type": "input_value",
          "name": "VALUE",
...
Blockly.Blocks['math_random_seed'] = {
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.ARDUINO_MATH_RANDOM_SEED_TITLE || "randomSeed( %1 );",
      "args0": [
        {
          "type": "input_value",
          "name": "SEED",
...
Blockly.Blocks['math_random_int'] = {
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.ARDUINO_MATH_RANDOM_INT_TITLE || "random( %1, %2 )",
      "args0": [
        {
          "type": "input_value",
          "name": "MIN",
