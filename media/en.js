(function(Blockly) {
  ...
  Object.assign(Blockly.Msg, {
    ...
    "ARDUINO_STRUCTURE_CATEGORY_ANGEL": "Structure",
    "ARDUINO_IO_CATEGORY_ANGEL": "I/O",
    "ARDUINO_TIME_CATEGORY_ANGEL": "Time",
    "ARDUINO_SERIAL_CATEGORY_ANGEL": "Serial",
    "PICAR_CATEGORY_ANGEL": "πCar",
    "CODING_CATEGORY_ANGEL": "Coding",
    "LOGIC_CATEGORY_ANGEL": "Logic",
    "LOOPS_CATEGORY_ANGEL": "Loops",
    "MATH_CATEGORY_ANGEL": "Math",
    "TEXT_CATEGORY_ANGEL": "Text",
    "VARIABLES_CATEGORY_ANGEL": "Variables",
    "ARRAY_CATEGORY_ANGEL": "Array",
    "FUNCTIONS_CATEGORY_ANGEL": "Functions",
    ...
    "PICAR_INIT": "Initialize πCar",
    "PICAR_INIT_TOOLTIP": "Initializes the required pins and variables for πCar, and starts the πCar in standby mode.",
    ...
    "PICAR_RESET": "Restart πCar",
    "PICAR_RESET_TOOLTIP": "Restarts the πCar.",
    ...
    "BKY_CUSTOM_FUNCTIONS_MUTATORCONTAINER_MSG_ENGINEER": "function inputs",
    "BKY_CUSTOM_FUNCTIONS_MUTATORARG_MSG_ENGINEER": "parameter",
    "BKY_CUSTOM_FUNCTIONS_RETURN_MSG_ENGINEER": "return %1",
    // Angel
    "BKY_CUSTOM_FUNCTIONS_DEFNORETURN_MSG_ANGEL": "do task %1 (%2)",
    "BKY_CUSTOM_FUNCTIONS_DEFRETURN_MSG_ANGEL": "do task %2 (%3) and report back %1",
    "BKY_CUSTOM_FUNCTIONS_CALLNORETURN_MSG_ANGEL": "do task %1 (%2)",
    "BKY_CUSTOM_FUNCTIONS_CALLRETURN_MSG_ANGEL": "get report from task %1 (%2)",
    "BKY_CUSTOM_FUNCTIONS_MUTATORCONTAINER_MSG_ANGEL": "function inputs",
    "BKY_CUSTOM_FUNCTIONS_MUTATORARG_MSG_ANGEL": "parameter",
    "BKY_CUSTOM_FUNCTIONS_RETURN_MSG_ANGEL": "report back %1",
    // Tooltip
    ...
    "FUNCTIONS_IFRETURN_TOOLTIP": "Returns a value from a function if a value is true.",
